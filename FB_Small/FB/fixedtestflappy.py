...
# TEST SAVED MODEL WITHOUT TRAINING - FIXED PATTERN
...
class GameEnvironment:
    def __init__(self, render=True):
        ...
        if self.render:
            pygame.display.set_caption('Flappy Bird AI - TEST MODE (Fixed Pattern)')
    ...
    def _get_state(self):
        ...
        # ADD THIS: Normalized absolute Y-position of the gap center
        gap_center_y / SCREEN_HEIGHT  
        ])
        return state
    ...
    def step(self, action):
        ...
        if is_off_screen(self.pipe_group.sprites()[0]):
            ...
            # Pattern generation called here
...
if __name__ == "__main__":
    ...
    print("\n--- STARTING TEST RUN (FIXED PATTERN) ---")
